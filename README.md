...
```bash
npm install @ssfm/gantt-task-react
```

## How to use it

```javascript
import { Gantt, Task, EventOption, StylingOption, ViewMode, DisplayOption } from '@@ssfm/gantt-task-react';
import "@ssfm/gantt-task-react/dist/style.css";
